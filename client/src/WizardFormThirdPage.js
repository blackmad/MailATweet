...
let WizardFormThirdPage = props => {
  ...
  const getShortAddressFieldFromGeoDestination = (fieldName, geoDestination) => {
    const field = geoDestination.address_components
      .find(component => component.types.includes(fieldName));
  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label>Address</label>
          <Geosuggest onSuggestSelect={onSuggestSelect(dispatch)}/>
        </div>
    ...
    <div>
      <label>Country</label>
      <div>
          <Field name="address_country" component="select">
